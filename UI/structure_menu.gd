...
func initialize_ui(owner_world: IslandWorld, target_structure: WorldStructure):
...
func generate_villager_list() -> void:
	...
	for villager in current_world.characters:
		if not villager.current_job:
			var new_button = villager_assignment_button_scene.instantiate() as VillagerAssignmentButton
...
func close_window() -> void:
	var parent = get_parent() as WorldUI
